...
|
*/
$config['security_code'] = ""; /* TODO: Fill it! /Ayos */
...
|--------------------------------------------------------------------------
*/
$config['server_name'] = "WoW Reforged";
...
|--------------------------------------------------------------------------
*/
$config['realmlist'] = "wowreforged.ddns.net";
...
|
*/
$config['disabled_expansions'] = array(1,2,3,4,5,6,7,8);
...
|
*/
$config['keywords'] = "world of warcraft,wow,private,private server,server,modded,custom,mod,best,quality,reforged,refined,redefined";
$config['description'] = "This is the best World of Warcraft custom modded private server!";
