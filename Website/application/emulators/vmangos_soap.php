...
class vmangos_soap implements Emulator
{
	...
	protected $columns = array(
		...
		"characters" => array(
			...
			"online" => "online",
			"money" => "money",
			"totalKills" => "honorStoredHK",
			"totalHonorPoints" => "honorStoredDK",
	...
	protected $queries = array(
		...
		"get_item" => "SELECT entry, flags, name, quality, bonding, inventory_type, max_durability, armor, required_level, item_level, class, subclass, dmg_min1, dmg_max1, dmg_type1, holy_res, fire_res, nature_res, frost_res, shadow_res, arcane_res, delay, spellid_1, spellid_2, spellid_3, spellid_4, spellid_5, spelltrigger_1, spelltrigger_2, spelltrigger_3, spelltrigger_4, spelltrigger_5, display_id, stat_type1, stat_value1, stat_type2, stat_value2, stat_type3, stat_value3, stat_type4, stat_value4, stat_type5, stat_value5, stat_type6, stat_value6, stat_type7, stat_value7, stat_type8, stat_value8, stat_type9, stat_value9, stat_type10, stat_value10, stackable FROM item_template WHERE entry=?",
