...
//L10 MODIFIED
const uint32 BG_WSG_FlagCapturedHonor[MAX_BATTLEGROUND_BRACKETS] = { 82, 136, 226, 396 };
const uint32 BG_WSG_WinMatchHonor[MAX_BATTLEGROUND_BRACKETS] = { 41, 68, 113, 198 };
const uint32 BG_WSG_WinMatchHonorHolidays[MAX_BATTLEGROUND_BRACKETS] = { 82, 136, 226, 396 };
const uint32 BG_WSG_WinMatchHonorBonusCompleteHolidays[MAX_BATTLEGROUND_BRACKETS] = { 123, 204, 339, 594 };
