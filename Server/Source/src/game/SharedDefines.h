...
enum SkillType
{
    ...
    SKILL_RIDING                   = 762,
	//L10 MODIFIED
	SKILL_SPELL_FIRE = 763,
	SKILL_SPELL_FROST = 765,
	SKILL_SPELL_ARCANE = 766,
	SKILL_SPELL_HOLY = 768,
	SKILL_SPELL_SHADOW = 769,
	SKILL_SPELL_NATURE = 770,
};

//L10 MODIFIED
#define MAX_SKILL_TYPE               771
