...
class Player final: public Unit
{
    ...
    public:
		...
		//L10 MODIFIED
		void PrintXpLimitReachedToChat();
    ...
    public:
		...
		//L10 MODIFIED
		uint32 GetMaxKeyringSize() const { return 12; }
		//ORIGINAL
    ...
    public:
		...
		//L10 MODIFIED
		void GiveXP(uint32 xp, Unit* victim, bool allowLeveling);
		//-----------
    ...
    public:
		...
		//L10 MODIFIED
		void UpdateSpellSkill(const SpellEntry* spell, const Unit* target, int targetCount);
		bool ShouldSpellFail(const SpellEntry * spell);
		bool IsSpellRejected(const SpellEntry* spell);
		bool CheckClassSchools(uint32 spellSchool);
		uint16 GetSkillValueForSchool(uint32 school);
		uint16 GetSkillValueForSchoolMask(SpellSchoolMask schoolMask);
		uint32 GetSelfHarmSpell(uint32 school);
		//------------
